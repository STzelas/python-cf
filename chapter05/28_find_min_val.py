def main():
  ...
  student_with_min_grade = min(students, key=students.get) # δεν καλώ την get αλλα του λέω θα εφαρμόσεις ως get την function get πάνω στο students και τα αποτελεσματα θα τα filtrareis και θα φερεις το min
